...
ARG RABBITMQ_HEALTH_CHECK_INTERVAL
ARG RABBITMQ_MAX_IDLE_TIME
ARG RABBITMQ_MAX_CONNECTION_AGE
...
ENV RABBITMQ_HEALTH_CHECK_INTERVAL=$RABBITMQ_HEALTH_CHECK_INTERVAL
ENV RABBITMQ_MAX_IDLE_TIME=$RABBITMQ_MAX_IDLE_TIME
ENV RABBITMQ_MAX_CONNECTION_AGE=$RABBITMQ_MAX_CONNECTION_AGE
